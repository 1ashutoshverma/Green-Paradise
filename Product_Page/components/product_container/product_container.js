let products = [
    ...
    {img:"./images/5-kg-cow-manure.webp",name:'Cow Manure',price:'199',category:"Fertiliser"},
    {img:"./images/5-kg-vermicompost.webp",name:'Vermicompost',price:'199',category:"Fertiliser"},
    {img:"./images/organic-manure-1-kg.webp",name:'Organic Manure - 1 Kg',price:'199',category:"Fertiliser"},
    {img:"./images/perlite-250gm.webp",name:'Perlite - 250gm',price:'199',category:"Fertiliser"},
    {img:"./images/epsom-salt-1-kg.webp",name:'Epsom Salt - 1 kg',price:'199',category:"Fertiliser"},
    {img:"./images/plant-fertilizer-pellets-1-kg.webp",name:'Plant Fertilizer Pellets - 1 Kg',price:'299',category:"Fertiliser"},
    {img:"./images/organic-manure-1-kg.webp",name:'Organic Manure - 1 Kg',price:'199',category:"Fertiliser"},
    {img:"./images/Plant_Tonic.webp",name:'Seaweed Extract Fertilizer - Plant Tonic 250 ml',price:'299',category:"Fertiliser"},
    {img:"./images/Plant_Tonic.webp",name:'Seaweed Extract Fertilizer - Plant Tonic 100 ml',price:'199',category:"Fertiliser"},
]

let tall = [{img:"./images/monstera-deliciosa-plant-xl.webp",name:'Monstera Deliciosa Plant - XL',price:'2999',category:"Houseplants"},
    {img:"./images/monstera-deliciosa.webp",name:'Monstera Deliciosa Plant',price:'1299',category:"Houseplants"},
    ]
