...
let popularProductsRender=(start=0,till=3)=>{
    ...
    for(start;start<end && start<products.length;start++){
        ...
        productInfoContainer.style.cssText = "display:flex; flex-direction:row; justify-content:space-around;padding:5px 15px; align-items:center";
      ...
      setTimeout(()=>{
        ...
        div.addEventListener("mouseenter", () => localStorage.setItem('Current_Product', JSON.stringify(el)));
